...
//		
//		for (String currWord:noAnagList)
//		{
//			String reverse = "";
//			int length = currWord.length();
//	
//		    for (int i = length - 1; i >= 0; i--)
//		      reverse = reverse + currWord.charAt(i);
//	
//		    if (currWord.equals(reverse))
//		    	palindromeList.add(currWord); 
//		    
//		}
...
//		System.out.println("There are "+palindromeList.size()+" palindroms of length "+ variable);
